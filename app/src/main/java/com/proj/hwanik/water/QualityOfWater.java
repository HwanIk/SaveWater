...
public class QualityOfWater extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qality_of_water);
...
//         data.setData(generateCandleData());
    ...
    private BarData generateBarData() {
        ...
        for (int index = 0; index < itemcount; index++)
            entries.add(new BarEntry(50000, index));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_qality_of_water, menu);
        return true;
    }
}
